...
<head>
    ...
    <title>Ajouter un Livre - Administration Bayt Al-Kitab</title>
...
<body class="bg-gray-100">
        ...
        <main class="container mx-auto px-6 py-8">
            <div class="max-w-4xl mx-auto">
                <div class="bg-white rounded-lg shadow-md p-6">
                    <h2 class="text-2xl font-bold mb-6 text-gray-800">Nouveau Livre</h2>
                    ...
                    <form method="POST" action="{{ route('admin.books.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            ...
                            <div>
                                ...
                                <input type="text" name="format" id="format" value="{{ old('format') }}" placeholder="ex: Broché, 15x21cm"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500">
                            </div>
                            ...
                            <div>
                                ...
                                <select name="audience" id="audience"
                                    ...
                                    <option value="enfants" {{ old('audience') == 'enfants' ? 'selected' : '' }}>Enfants</option>
                                    <option value="adultes" {{ old('audience') == 'adultes' ? 'selected' : '' }}>Adultes</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <!-- Images Upload -->
                        <div class="mb-8">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Images du livre</label>
                            <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                                ...
                                <label for="images" class="cursor-pointer">
                                    <div class="text-gray-600">
                                        ...
                                        <p class="mt-2">Cliquez pour sélectionner des images</p>
                        ...
                        <div class="mb-8">
                            ...
                            <textarea name="summary" id="summary" rows="3" maxlength="512"
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500">{{ old('summary') }}</textarea>
                        ...
                        <!-- Sale Price -->
                        <div class="mb-8" id="sale-price-section" style="display: none;">
    ...
    <script>
        ...
        function removeImage(index) {
            // This would need more complex handling for multiple file removal
